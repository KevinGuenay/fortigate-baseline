...
* A [**fortigate\_baseline\_no\_input\_safe\_create.conf**](./resources/configurations/fortigate_baseline_no_input_safe_create.conf) is available that does everything the “no\_input” file does, but also creates objects (addresses, security profiles, threat feeds, etc.), but does not use them. All created objects have the prefix “**BASE\_”**.  
